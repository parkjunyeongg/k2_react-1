   ...
   let divTags = [];
    ...
    /*for (let item of mvlist){
        ...
        for (let [k,v] of Object.entries(item)){
            //console.log(k,v);
            /*case 1
            if (k== 'rank' || k == 'movieNm' || k=='rankInten') {
                console.log(k,v);
            }*/
            /*case 2
            if (klist.includes(k)) {
    ...
    return (
        <div className="content">
           <div className="rowDiv">
                <sapn className="col" id="colrank">순위</sapn>
                <sapn className="col" id="colmovieNm">영화명</sapn>
                <sapn className="col" id="colsalesAmt">매출액</sapn>
                <sapn className="col" id="colrankInten">증감률</sapn>
           </div>
           {divTags}
        </div>
